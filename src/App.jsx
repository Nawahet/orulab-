...
const DILEMMAS = [
  ...
  { id: 8, cat: "Honesty", q: "Would you tell a terminally ill loved one an uncomfortable truth if it might cause them distress in their final months?", ctx: "The truth concerns something they always wanted to know. Telling them now changes nothing practical. It might bring peace or it might bring pain — you genuinely don't know which." },
  { id: 9, cat: "Honesty", q: "You made a small error at work that nobody noticed. It had no real consequences. Do you confess?", ctx: "Confessing means a difficult conversation with your manager. There's a performance review in three weeks. The error is now fully resolved. Saying nothing is the path of zero resistance." },
  ...
  // LIFE & DEATH
  { id: 11, cat: "Life & Death", q: "Your parent is in a vegetative state with no advance directive. Doctors say there is a 2% chance of meaningful recovery. Keeping them alive costs £12,000 a month.", ctx: "Your sibling wants to keep them alive indefinitely. You don't. The hospital is asking for a decision by end of week. Your parent once said casually they'd never want to be 'a vegetable.'" },
  { id: 12, cat: "Life & Death", q: "A close friend tells you they are seriously considering ending their life. They are not in immediate danger and say they've thought about it calmly for months.", ctx: "They are not asking for help. They say they just needed to tell someone. They ask you to keep it secret. They don't seem impulsive — they seem resolved." },
  ...
  { id: 14, cat: "Life & Death", q: "You are told you have 12 months to live. The treatment that could extend your life by 3–5 years is gruelling — you'd be largely incapacitated for most of it.", ctx: "Your children are 8 and 10. More time means more time with them but most of it in hospitals. Less time means a better quality of remaining life but dying sooner." },
  { id: 15, cat: "Life & Death", q: "Is it moral to bring a child into a world you genuinely believe is heading toward catastrophe?", ctx: "You want children deeply. You also believe, based on evidence, that their generation faces existential risks yours didn't. Your partner disagrees and wants to start a family now." },
  ...
  { id: 18, cat: "Justice", q: "You know with certainty that someone convicted of a crime is actually innocent. Coming forward would require you to admit something that would seriously damage your own reputation.", ctx: "The convicted person is serving five years and has a young family. What you'd have to admit is not illegal but would be personally devastating. Nobody is pressuring you to speak." },
  ...
  { id: 20, cat: "Justice", q: "You are an employer and discover that a candidate who lied on their CV is, after six months, your best-performing employee.", ctx: "Nobody else knows. Firing them means losing someone genuinely excellent and putting them out of work. Keeping them means rewarding dishonesty. HR policy is unambiguous: termination." },

  // MONEY
  { id: 21, cat: "Money", q: "You find a holdall containing £80,000 in cash in your local park. No ID, no phone, nothing traceable.", ctx: "You're three months behind on rent and have two kids. The cash appears clean. You ask yourself: who carries £80k in a holdall and reports it missing?" },
  { id: 22, cat: "Money", q: "A billing error means you've been undercharged by a significant amount over 18 months. The company hasn't noticed.", ctx: "The company is a large corporation. The amount totals just over £3,000. Reporting it means repaying it all at once. You can afford to repay it but it would hurt. The error was entirely their fault." },
  { id: 23, cat: "Money", q: "You are offered a dream job that pays three times your salary — but it's at an oil company actively lobbying against climate legislation.", ctx: "You have significant debt. The salary would change your life within three years. A close friend works in climate policy and would consider it a personal betrayal." },
  { id: 24, cat: "Money", q: "Is it wrong to buy luxury goods when others are starving?", ctx: "You've worked hard for your money and earned it entirely legally. You give a small amount to charity each month. The luxury item in question costs £600. You want it. It would genuinely make you happy." },
  ...
  { id: 27, cat: "Relationships", q: "Your long-term partner admits they find one of your close friends deeply attractive and have for years. They haven't acted on it.", ctx: "The three of you regularly spend time together. Nothing has happened. Your partner says they're not asking for anything — just didn't want the secret. You must now decide if this changes anything." },
  { id: 28, cat: "Relationships", q: "You realise you are no longer in love with your partner but genuinely believe you are the best thing in their life and leaving would devastate them.", ctx: "They have no idea. You've been together four years. They recently turned down a job abroad partly because of you. You could stay and be a good partner — just not a passionate one." },
  { id: 29, cat: "Relationships", q: "Your partner of seven years tells you they're no longer in love with you but wants to stay together for stability and the life you've built.", ctx: "They're not unhappy. They still care for you deeply. They say they may fall back in love — or may not. They'll leave if you want them to. But they're not asking to leave." },
  { id: 30, cat: "Relationships", q: "A close friend group has quietly decided to stop inviting one member to things. Nobody has told them directly. You are the closest to them.", ctx: "The excluded person has become difficult to be around. Nobody wants the confrontation. The person asks you directly if something is wrong. You are the only one who will tell them the truth." },
  ...
  { id: 32, cat: "Family", q: "Would you put a parent in a care home if they didn't want to go — but needed a level of care you genuinely cannot provide?", ctx: "They are frightened and upset at the suggestion. You've been their carer for two years and it's affecting your health and your own family. The care home is excellent. They would be safe." },
  { id: 33, cat: "Family", q: "Your sibling commits a serious crime. Do you turn them in?", ctx: "The crime harmed someone outside the family. Your sibling is remorseful and says they will turn themselves in within a week. They've said this before about smaller things and never followed through." },
  { id: 34, cat: "Family", q: "Your parents are divorcing after 35 years. Both are trying to get you to take sides and share private things the other has said.", ctx: "You love both of them. One is clearly more at fault than the other. They are both asking you to validate their position. Your siblings have chosen sides. You haven't." },
  ...
  { id: 37, cat: "Technology", q: "You discover your teenage child has been using AI to write all of their school essays for six months and is getting top grades.", ctx: "They're engaging with the material — they just can't write well yet. Their school has a strict policy. You know other parents who've turned a blind eye. Their future depends on grades right now." },
  { id: 38, cat: "Technology", q: "You can install tracking software on your elderly parent's phone to monitor their safety without telling them.", ctx: "They have early-stage dementia and have wandered twice. They've explicitly said they don't want to be monitored: 'I'm not a child.' Your sibling thinks it's essential." },
  ...
  // SOCIETY
  { id: 46, cat: "Society", q: "You find out a neighbour — who has become a close friend — is in the country illegally. They have two children born here.", ctx: "They confide in you during a vulnerable moment. Reporting them would almost certainly result in deportation. Not reporting means harbouring the secret indefinitely. The children speak no other language." },
  { id: 47, cat: "Society", q: "You're at a dinner party and a guest makes a casually racist comment. Several people laugh nervously.", ctx: "You don't know the guest well. Your host is clearly uncomfortable but says nothing. Two close friends at the table also say nothing. The guest doesn't seem to realise how it landed." },
  { id: 48, cat: "Society", q: "Should voting be made compulsory?", ctx: "Turnout in most democracies is below 60%. Low-income and young voters are disproportionately absent. Compulsory voting exists in Australia with minimal controversy. Others argue it violates freedom." },
  { id: 49, cat: "Society", q: "A homeless person you pass every day asks you for money. You suspect they'll spend it on alcohol.", ctx: "It's -3°C. They know your name because you've given them food before. You have £20 in your pocket. They say: 'I just need a drink to get through tonight.'" },
  { id: 50, cat: "Society", q: "Is it wrong to live a deliberately ordinary life when you have the intelligence and opportunity to do more?", ctx: "You are by most measures highly capable. You have chosen comfort, stability, and a quiet life. You are happy. Society could theoretically benefit if you applied yourself more ambitiously. You don't want to." },
  ...
  { id: 54, cat: "Philosophy", q: "If you could go back in time and kill Hitler as a child, would you?", ctx: "You know everything that follows. The child has done nothing wrong yet. You are the only one who knows the future. Your action is certain to prevent the Holocaust. You have one minute." },
  { id: 55, cat: "Philosophy", q: "A doctor must allocate one kidney to either a 70-year-old who will live 10 comfortable years with it, or a 25-year-old who will live 50+ years.", ctx: "Both are equally in need medically. Both have families. The younger person has a history of not following medical advice. The older person has been waiting three years. You are the doctor." },

  // PRIVACY
  { id: 56, cat: "Privacy", q: "You have the opportunity to read your teenage child's private messages. You have a genuine concern they may be in danger.", ctx: "They've been withdrawn for six weeks. A friend of theirs suggested 'something is going on.' Your child has explicitly said they want their privacy respected." },
  ...
  { id: 58, cat: "Privacy", q: "Your company has been monitoring all employee communications — emails, Slack, everything — without clearly disclosing it.", ctx: "It's probably legal under buried terms. You discover this because a colleague found it. Some of your messages are deeply personal. Others could be professionally damaging if misread." },
  { id: 59, cat: "Privacy", q: "Should governments have the right to access encrypted private messages for national security investigations?", ctx: "End-to-end encryption currently makes certain communications invisible to authorities. Some attacks have been planned via encrypted apps. Backdoors would make all communications theoretically accessible." },
  { id: 60, cat: "Privacy", q: "You accidentally receive an email clearly meant for someone else — it contains very sensitive personal information about a mutual acquaintance.", ctx: "The sender hasn't noticed their mistake. The information would change how you see the acquaintance significantly. Deleting without reading further would be clean — but you've already seen the key part." },

  // WAR
  { id: 61, cat: "War", q: "A drone strike can take out a known terrorist leader — but 12–15 civilians, including children, will likely be killed.", ctx: "The target has planned three attacks in the past year. Each was carried out. Another is believed imminent. You are the one who must authorise the strike." },
  ...
  { id: 63, cat: "War", q: "You are a civilian in an occupied territory. A resistance fighter knocks on your door. You can hide them — saving their life — but if discovered, your family will be punished.", ctx: "Your family includes a young child. The penalty for harbouring is severe. Not helping means certain death for the fighter. You have 60 seconds to decide." },
  { id: 64, cat: "War", q: "Is it ever moral to sell weapons to countries with poor human rights records?", ctx: "The purchasing country is an ally with significant strategic value. The weapons are defensive. The human rights abuses are documented but not ongoing genocide. The deal would support thousands of domestic jobs." },
  ...
  // HEALTH
  { id: 66, cat: "Health", q: "Should healthcare be rationed based on lifestyle choices — refusing treatment to people whose conditions are self-caused?", ctx: "A smoker needs a lung transplant. The donor organ is scarce. A non-smoker with identical medical need is also waiting. The smoker has quit. The non-smoker never smoked. You are the committee." },
  ...
  { id: 69, cat: "Health", q: "Your friend confides they've been diagnosed with a hereditary condition their adult sibling almost certainly also has — but they refuse to tell their sibling.", ctx: "The sibling is planning to have children. Early diagnosis could prevent passing the condition on. Your friend says it's their medical information to share or not. They've asked you to stay out of it." },
  { id: 70, cat: "Health", q: "Should vaccines be legally mandatory for public school attendance if herd immunity is at stake?", ctx: "Vaccination rates in your area have dropped below the threshold for herd immunity. There have been three outbreaks in two years. Some parents have religious objections. Some have medical exemptions." },

  // HYPOTHETICAL
  { id: 71, cat: "Hypothetical", q: "You can live to 150 in perfect health — but you will outlive everyone you currently love by decades and cannot choose to die early.", ctx: "You would watch your children, partner, and friends all die. You'd have 60–80 years alone at the end. In exchange: fully present, healthy, financially secure throughout." },
  { id: 72, cat: "Hypothetical", q: "You can press a button that guarantees your child has a happy, safe, comfortable — but entirely ordinary — life.", ctx: "The alternative is an unpredictable life that might mean great achievement, passionate love, and real meaning — or it might mean hardship and pain. You must choose before they're born." },
  ...
  { id: 74, cat: "Hypothetical", q: "You discover your entire life — memories, relationships, experiences — has been a simulation. You can continue or exit to an unknown reality.", ctx: "Everything you love exists only inside the simulation. What's outside is entirely unknown. It might be nothing. You have 60 seconds to decide." },
  ...
  // EVERYDAY
  { id: 76, cat: "Everyday", q: "You return to your car to find you've scraped a parked vehicle — a small but clear mark. There are no witnesses.", ctx: "Your dashcam caught the incident. You could delete the footage. Leaving a note means a claim, higher insurance, and significant inconvenience. The other car is a new, expensive model." },
  ...
  { id: 82, cat: "Work", q: "Your colleague is clearly being managed out — impossible targets, subtle humiliations — and asks you to support them in an employment tribunal.", ctx: "You've witnessed what they've described. Coming forward puts you in direct conflict with your shared manager. HR has already informally signalled which side the company is on. You like your job." },
  ...
  { id: 88, cat: "Faith", q: "A close friend from a different culture asks you to participate in a religious ceremony you find morally uncomfortable but that means a great deal to them.", ctx: "Refusing would be a significant slight. Participating feels like a compromise of your values — though you'd cause no harm by going. They've supported you at every major moment in your life." },
  ...
  // POLITICS
  { id: 91, cat: "Politics", q: "Is civil disobedience ever morally justified against a democratically elected government?", ctx: "The government was fairly elected. The policy in question is legal but, in your view, deeply unjust. Legal protest has had no effect over three years. The disobedience would be nonviolent." },
  { id: 92, cat: "Politics", q: "Would you vote for a candidate you find personally morally repugnant if you genuinely believed they would govern better?", ctx: "The alternative candidate is personally decent but, you believe, dangerously incompetent. The election is very close. Your constituency is marginal. Your partner disagrees completely." },
  ...
  { id: 95, cat: "Politics", q: "You can expose a corrupt politician who will definitely resign — but the leak would require you to break a legally binding NDA.", ctx: "The information is in the public interest. The NDA was signed under pressure. Breaking it exposes you to a significant lawsuit. The politician is currently running for re-election." },
  ...
  { id: 103, cat: "Identity", q: "Should people be able to legally change their age as well as their gender, if their subjective experience of their age is genuinely different from their biological one?", ctx: "A 69-year-old man in the Netherlands attempted this legally, arguing he felt 49. The principle of self-identification already applies to gender in many countries. Where should it stop?" },
  { id: 104, cat: "Identity", q: "Are you responsible for the harm caused by your ancestors — and if so, what does that responsibility look like?", ctx: "Your family benefited economically from something that harmed others generations ago. You did nothing wrong. You also benefit, indirectly, from that history today." },
  { id: 105, cat: "Identity", q: "Is it possible to be genuinely good if you only avoid harmful actions out of fear of consequences rather than moral conviction?", ctx: "You have never stolen, cheated, or hurt anyone. You've also never been in a situation where the risk of getting caught was low enough that you were truly tested." },
];

const CATEGORIES = ["All", ...Array.from(new Set(DILEMMAS.map(d => d.cat)))];

// ─────────────────────────────────────────────────────────────────────────────
// DESIGN TOKENS — Chrome / Futuristic / Monochrome
// ─────────────────────────────────────────────────────────────────────────────
const T = {
  bg: "#070709",
  surface: "#0c0c10",
...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .chrome-text {
    background: linear-gradient(135deg, #a8b0c0 0%, #eef0f4 30%, #8090a8 50%, #eef0f4 70%, #a8b0c0 100%);
  ...
  .gold-text {
    background: linear-gradient(135deg, #c8963a 0%, #f0d070 40%, #c8963a 70%, #f0d070 100%);
    background-size: 200% auto;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
  ...
  .btn-chrome::before {
    ...
    position: absolute;
    inset: 0;
    background: linear-gradient(180deg, rgba(200,205,216,0.06) 0%, transparent 100%);
    opacity: 0;
  ...
  .btn-primary {
    background: linear-gradient(180deg, #303040 0%, #1e1e2a 100%);
    border: 1px solid ${T.chrome};
    color: ${T.white};
    padding: 14px 28px;
    font-family: ${F.mono};
    font-size: 11px;
...
// ─────────────────────────────────────────────────────────────────────────────
// REALTIME ROOM HOOK — syncs across all devices via Supabase
// ─────────────────────────────────────────────────────────────────────────────
...
function useRoom(code) {
  ...
  useEffect(() => {
    if (!code) return;
    dbGetRoom(code).then(state => {
      if (state) { setRoom(state); roomRef.current = state; }
    });
...
// Keep localStorage helpers for room creation handoff
function useDemoRoom(code, interval = 600) {
  return useRoom(code);
}
...
function pickQuestion(exclude = []) {
  const pool = DILEMMAS.filter(d => !exclude.includes(d.id));
  return pool[Math.floor(Math.random() * pool.length)];
}

// ─────────────────────────────────────────────────────────────────────────────
// CHROME ORB (brand signature element)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div style={{ position: "relative", width: size, height: size, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        background: `radial-gradient(circle at 35% 35%, ${c}cc 0%, ${c}66 30%, ${c}22 60%, ${T.bg} 100%)`,
        border: `1px solid ${c}80`,
        boxShadow: `0 0 ${size / 2}px ${c}30, inset 0 1px 0 ${c}60`,
        position: "relative",
        overflow: "hidden",
      }}>
        <div style={{
        ...
        <div style={{
          position: "absolute", left: "15%", top: 0, width: "12%", height: "100%",
...
function TopBar({ code, round, phase, playerCount }) {
  return (
    <div style={{
      ...
      background: T.bg + "f0", borderBottom: `1px solid ${T.border}`,
...
function Landing({ onHost, onJoin }) {
  ...
  const cats = CATEGORIES.slice(1, 9);
  return (
    <div style={{ minHeight: "100vh", background: T.bg }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `radial-gradient(circle, ${T.chrome}06 0%, transparent 70%)`,
          pointerEvents: "none",
        }} />

        <div style={{ position: "relative", animation: "fade-up 0.6s ease both" }}>
          <ChromeOrb size={72} pulse phase="idle" />
        </div>

        <h1 className="chrome-text" style={{
          fontFamily: F.display, fontSize: "clamp(80px, 20vw, 200px)",
          letterSpacing: "0.08em", lineHeight: 0.9,
          margin: "32px 0 0", position: "relative",
          animation: "fade-up 0.6s 0.1s ease both", opacity: 0,
          animationFillMode: "forwards",
        }}>ORU</h1>

        <p style={{
          fontFamily: F.mono, fontSize: 11, letterSpacing: "0.4em",
          color: T.chromeDim, textTransform: "uppercase",
          margin: "20px 0 8px",
          animation: "fade-up 0.6s 0.2s ease both", opacity: 0, animationFillMode: "forwards",
        }}>
          The moral dilemma game
        </p>
        <p style={{
          fontSize: 16, color: T.chromeDim, maxWidth: 480, lineHeight: 1.7,
          margin: "0 0 48px",
          animation: "fade-up 0.6s 0.3s ease both", opacity: 0, animationFillMode: "forwards",
        }}>
          Anonymous answers. Blind voting. Then everyone finds out who said what.
          Two sentences. No right answers.
        </p>

        <div style={{
          display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center",
          animation: "fade-up 0.6s 0.4s ease both", opacity: 0, animationFillMode: "forwards",
        }}>
          <button className="btn-primary" onClick={onHost} style={{ fontSize: 12, padding: "16px 40px" }}>
            Host a Game
          </button>
          <button className="btn-chrome" onClick={onJoin} style={{ fontSize: 12, padding: "16px 40px" }}>
            Join with Code
          </button>
        </div>

        {DEMO_MODE && (
          <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, marginTop: 24, letterSpacing: "0.15em" }}>
            DEMO MODE — Add Supabase credentials for real multiplayer
          </p>
        )}
      </div>
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, padding: "80px 24px", maxWidth: 960, margin: "0 auto" }}>
        <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: 48, textAlign: "center" }}>
          How it works
        </p>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 1 }}>
          {[
            { n: "01", title: "Host picks a room", body: "One device creates the room. Everyone joins on their own phone with the code." },
            { n: "02", title: "Answer anonymously", body: "A dilemma drops. Everyone writes their response in exactly two sentences." },
            { n: "03", title: "Vote blind", body: "All answers revealed with no names. Vote for your favourite and least favourite." },
            { n: "04", title: "Hot Seat", body: "One player is randomly put in the hot seat to defend their answer to the group live." },
            { n: "05", title: "Reveal", body: "Names exposed. Points awarded. The real debate begins." },
            { n: "06", title: "Repeat", body: "Next round. Different dilemma. Same room. Things get personal." },
          ].map((step, i) => (
      ...
      {/* Categories */}
      <div style={{ borderTop: `1px solid ${T.border}`, padding: "80px 24px", maxWidth: 960, margin: "0 auto" }}>
        <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: 32, textAlign: "center" }}>
          {DILEMMAS.length}+ dilemmas across {CATEGORIES.length - 1} categories
        </p>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center" }}>
          {CATEGORIES.slice(1).map((cat, i) => (
            <span key={cat} className="tag" style={{
              color: T.chromeDim, cursor: "default",
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, padding: "80px 24px", maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 1 }}>
          {[
            { pts: "+3", label: "Favourite vote", color: T.gold },
            { pts: "+1", label: "Least fav vote", color: T.chrome },
            { pts: "+5", label: "Survive hot seat", color: T.red },
            { pts: "+2", label: "Hot seat — group agrees", color: T.green },
          ].map((p, i) => (
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, padding: "80px 24px", textAlign: "center" }}>
        <h2 className="chrome-text" style={{ fontFamily: F.display, fontSize: "clamp(40px, 10vw, 80px)", letterSpacing: "0.1em", marginBottom: 32 }}>
          START A GAME
        </h2>
        ...
        <p style={{ fontFamily: F.mono, fontSize: 10, color: T.border, marginTop: 60, letterSpacing: "0.2em" }}>
          ORU — PLAY ANYWHERE
        </p>
      </div>
    </div>
...
function HostSetup({ onBack, onCreated }) {
  ...
  const [chatMode, setChatMode] = useState("hotseat"); // "hotseat" | "always" | "off"
...
function genId() { return Math.random().toString(36).slice(2, 10); }
  ...
  const create = async () => {
    ...
    const pid = genId();
    const room = {
      code, host: pid, phase: "lobby",
      players: { [pid]: { name: name.trim(), score: 0 } },
      settings: { category: cat, chatMode },
      round: 0, history: [], answers: {}, votes: {}, hotSeat: null, hotSeatVotes: {}, chat: [],
    };
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ maxWidth: 460, width: "100%" }}>
        ...
        <ChromeOrb size={52} />
        <h2 style={{ fontFamily: F.display, fontSize: 42, letterSpacing: "0.1em", margin: "24px 0 32px", textAlign: "center" }} className="chrome-text">HOST</h2>
        <div className="card animate-in" style={{ padding: "32px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 28 }}>
            {CATEGORIES.map(c => (
              <button key={c} onClick={() => setCat(c)} style={{
                background: cat === c ? T.chromeFaint : "transparent",
                border: `1px solid ${cat === c ? T.chrome : T.border}`,
                color: cat === c ? T.white : T.chromeDim,
                padding: "6px 12px", fontFamily: F.mono, fontSize: 9,
                letterSpacing: "0.15em", textTransform: "uppercase", cursor: "pointer", transition: "all 0.15s",
              }}>{c}</button>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 28 }}>
            {chatOptions.map(opt => (
              <button key={opt.id} onClick={() => setChatMode(opt.id)} style={{
                background: chatMode === opt.id ? T.chromeFaint : "transparent",
                border: `1px solid ${chatMode === opt.id ? T.chrome : T.border}`,
                color: chatMode === opt.id ? T.white : T.chromeDim,
                padding: "12px 16px", fontFamily: F.mono, fontSize: 10,
                letterSpacing: "0.1em", cursor: "pointer", transition: "all 0.15s",
                textAlign: "left", display: "flex", justifyContent: "space-between", alignItems: "center",
              }}>
                <span style={{ textTransform: "uppercase", letterSpacing: "0.15em" }}>{opt.label}</span>
                <span style={{ fontSize: 9, color: chatMode === opt.id ? T.chromeDim : T.border, fontWeight: 400, textTransform: "none", letterSpacing: "0.05em" }}>{opt.desc}</span>
              </button>
            ))}
          </div>
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ maxWidth: 420, width: "100%" }}>
        <button onClick={onBack} style={{ background: "none", border: "none", color: T.chromeDim, fontFamily: F.mono, fontSize: 11, letterSpacing: "0.15em", cursor: "pointer", marginBottom: 32, textTransform: "uppercase" }}>← Back</button>
        <ChromeOrb size={52} />
        <h2 style={{ fontFamily: F.display, fontSize: 42, letterSpacing: "0.1em", margin: "24px 0 32px", textAlign: "center" }} className="chrome-text">JOIN</h2>
        <div className="card animate-in" style={{ padding: "32px" }}>
          ...
          {err && <p style={{ fontFamily: F.mono, fontSize: 11, color: T.red, marginBottom: 16, letterSpacing: "0.05em" }}>{err}</p>}
...
function Lobby({ room, update, pid, isHost }) {
  ...
  const start = () => {
    ...
    const pool = cat === "All" ? DILEMMAS : DILEMMAS.filter(d => d.cat === cat);
    const q = pool.filter(d => !exclude.includes(d.id))[Math.floor(Math.random() * pool.filter(d => !exclude.includes(d.id)).length)] || pool[0];
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 24px 40px" }}>
      <div style={{ maxWidth: 500, width: "100%", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.3em", marginBottom: 40, textTransform: "uppercase" }}>
          Room code: <span style={{ color: T.gold, letterSpacing: "0.4em" }}>{room.code}</span>
        </p>

        <div className="card" style={{ padding: "28px", marginBottom: 24 }}>
          <p style={{ fontFamily: F.mono, fontSize: 9, color: T.chromeDim, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 20 }}>
            {names.length} player{names.length !== 1 ? "s" : ""} in room
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center" }}>
            {names.map((p, i) => (
              <div key={i} className="tag" style={{ color: T.chrome, animation: `slide-in 0.3s ${i * 0.05}s ease both`, opacity: 0, animationFillMode: "forwards" }}>
                {p.name}
              </div>
            ))}
          </div>
        ...
        {isHost ? (
          <>
            {names.length >= 2 ? (
              <button className="btn-primary" onClick={start} style={{ width: "100%" }}>Start Game →</button>
            ) : (
              <p style={{ fontFamily: F.mono, fontSize: 11, color: T.chromeDim, letterSpacing: "0.1em" }}>Waiting for at least 2 players…</p>
            )}
          </>
        ) : (
          <p style={{ fontFamily: F.mono, fontSize: 11, color: T.chromeDim, letterSpacing: "0.1em" }}>Waiting for host to start…</p>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "72px 24px 40px" }}>
      <div style={{ maxWidth: showChat ? 960 : 680, margin: "0 auto", display: "flex", gap: 28, alignItems: "flex-start" }}>
        ...
        {/* question */}
        <h1 style={{ fontSize: "clamp(20px, 3.5vw, 28px)", fontWeight: 400, lineHeight: 1.5, color: T.white, marginBottom: 20 }}>
          {q.q}
        </h1>

        {/* context */}
        <div style={{ borderLeft: `2px solid ${T.gold}`, paddingLeft: 20, marginBottom: 32, background: T.goldDim + "40" }}>
        ...
        {/* rule */}
        <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "12px 16px", marginBottom: 24, fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.1em" }}>
          RULE — Your answer must be exactly 2 sentences. Anonymous until after voting.
        </div>
        ...
        {!hasAnswered ? (
          <>
            <textarea
              ...
              placeholder="Write your answer. Two sentences maximum."
              rows={5}
              style={{
                background: T.surface, border: `1px solid ${T.border}`, color: T.white,
                padding: "16px 18px", fontSize: 15, fontFamily: F.body,
                lineHeight: 1.7, width: "100%", resize: "vertical", outline: "none",
                transition: "border-color 0.2s",
              }}
          ...
          <div style={{ background: T.blueDim, border: `1px solid ${T.blue}40`, padding: "24px", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: F.mono, fontSize: 11, color: T.blue, marginTop: 16, letterSpacing: "0.15em" }}>
              ANSWER SUBMITTED — {submitted}/{total} in
            </p>
            <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, marginTop: 8 }}>Waiting for other players…</p>
          </div>
        )}
        </div>
        {showChat && (
          <div style={{ width: 280, flexShrink: 0, position: "sticky", top: 60 }}>
  ...
  const castVote = () => {
    ...
    update(r => {
      ...
      if (Object.keys(next.votes).length >= Object.keys(next.players || {}).length) {
        // pick hot seat player randomly (weighted toward most answers)
        const pids = Object.keys(next.answers);
        const hotPid = pids[Math.floor(Math.random() * pids.length)];
        next.phase = "hotseat";
        next.hotSeat = hotPid;
        next.hotSeatVotes = {};
      }
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "72px 24px 40px" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }} className="animate-in">
        ...
        <p style={{ fontFamily: F.mono, fontSize: 9, color: T.chromeDim, letterSpacing: "0.15em", marginBottom: 28, textTransform: "uppercase" }}>
          {room.question?.q}
        </p>

        {!hasVoted && (
          <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "10px 16px", marginBottom: 20, fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.1em", display: "flex", gap: 20 }}>
            <span style={{ color: T.gold }}>★ = FAVOURITE (+3 pts)</span>
            <span style={{ color: T.red }}>✕ = LEAST FAV (+1 pt)</span>
            <span>Cannot vote for yourself</span>
          </div>
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
          {entries.map(([apid, answer], i) => {
            ...
            const border = isFav ? T.gold : isLeast ? T.red : T.border;
            return (
              <div key={apid} style={{ background: T.card, border: `1px solid ${border}`, padding: "18px 20px", transition: "border-color 0.15s" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  ...
                  {!hasVoted && !isMe && (
                    <div style={{ display: "flex", gap: 6 }}>
                      <button onClick={() => setFav(isFav ? null : apid)} style={{
                        background: isFav ? T.gold : "transparent", border: `1px solid ${T.gold}`,
                        color: isFav ? T.bg : T.gold, padding: "4px 12px",
                        fontFamily: F.mono, fontSize: 9, letterSpacing: "0.1em", cursor: "pointer", transition: "all 0.15s",
                      }}>★ FAV</button>
                      <button onClick={() => setLeast(isLeast ? null : apid)} style={{
                        background: isLeast ? T.red : "transparent", border: `1px solid ${T.red}`,
                        color: isLeast ? T.white : T.red, padding: "4px 12px",
                        fontFamily: F.mono, fontSize: 9, letterSpacing: "0.1em", cursor: "pointer", transition: "all 0.15s",
                      }}>✕ LEAST</button>
                    </div>
                  )}
...
function ChatPanel({ room, update, pid, hotSeatPid }) {
  ...
  const send = () => {
    const text = msg.trim();
    if (!text) return;
    const entry = { pid, name: myName, text, ts: Date.now(), isHotSeat: pid === hotSeatPid };
    update(r => ({ ...r, chat: [...(r.chat || []), entry] }));
    setMsg("");
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontFamily: F.mono, fontSize: 9, color: T.chromeDim,
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 8 }}>
        {messages.length === 0 && (
          <p style={{ fontFamily: F.mono, fontSize: 10, color: T.border, textAlign: "center", margin: "auto 0" }}>
            No messages yet.
          </p>
        )}
        {messages.map((m, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              {!isMe && (
                <div style={{ fontFamily: F.mono, fontSize: 9, color: isHS ? T.red : T.chromeDim, letterSpacing: "0.1em", marginBottom: 3 }}>
                  {m.name}{isHS ? " 🔴" : ""}
                </div>
              )}
              <div style={{
                background: isMe ? T.chromeFaint : T.card,
                border: `1px solid ${isHS ? T.red + "60" : isMe ? T.borderHi : T.border}`,
                padding: "8px 12px",
                fontSize: 13,
                lineHeight: 1.5,
                color: T.white,
      ...
      {/* input */}
      <div style={{ borderTop: `1px solid ${T.border}`, display: "flex", gap: 0 }}>
        <input
          ...
          style={{ flex: 1, border: "none", borderRight: `1px solid ${T.border}`, fontSize: 13, padding: "12px 14px", letterSpacing: "normal" }}
        />
        <button onClick={send} style={{
          background: "transparent", border: "none", color: T.chrome,
          padding: "12px 18px", cursor: "pointer", fontFamily: F.mono,
...
function HotSeat({ room, update, pid, isHost }) {
  ...
  const [defenceDone, setDefenceDone] = useState(!!room.defenceDone);
  const timerRef = useRef(null);
  const chatMode = room.settings?.chatMode || "hotseat";
  const showChat = chatMode === "hotseat" || chatMode === "always";
  ...
  // sync defenceDone from room state
  useEffect(() => { setDefenceDone(!!room.defenceDone); }, [room.defenceDone]);
  ...
  const calcAndAdvance = (hsv) => {
    update(r => {
      ...
      Object.values(v).forEach(vote => {
        if (vote.fav && updatedPlayers[vote.fav])
          updatedPlayers[vote.fav] = { ...updatedPlayers[vote.fav], score: (updatedPlayers[vote.fav].score || 0) + 3 };
        if (vote.least && updatedPlayers[vote.least])
          updatedPlayers[vote.least] = { ...updatedPlayers[vote.least], score: (updatedPlayers[vote.least].score || 0) + 1 };
      });
      const survivedVotes = Object.values(hsv).filter(Boolean).length;
      const voters = Object.keys(next.players || {}).filter(p => p !== next.hotSeat);
      const survivedMajority = survivedVotes > voters.length / 2;
      if (next.hotSeat && updatedPlayers[next.hotSeat]) {
        updatedPlayers[next.hotSeat] = { ...updatedPlayers[next.hotSeat], score: (updatedPlayers[next.hotSeat].score || 0) + (survivedMajority ? 5 : 2) };
      }
      next.players = updatedPlayers;
      next.history = [...(next.history || []), { id: next.question?.id, survivedHotSeat: survivedMajority }];
      return next;
    });
  };
  ...
  const voteHotSeat = (survived) => {
    update(r => {
      ...
      if (voters.every(p => newHSV[p] !== undefined)) {
        calcAndAdvance(newHSV);
        return r; // calcAndAdvance handles the state
      }
  ...
  const skipHotSeat = () => {
    // host skips — no score awarded, advance to results still calculating vote scores
    update(r => {
      const next = { ...r, phase: "results" };
      const v = next.votes || {};
      const updatedPlayers = { ...next.players };
      Object.values(v).forEach(vote => {
        if (vote.fav && updatedPlayers[vote.fav])
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "72px 24px 40px" }}>
      <div style={{ maxWidth: showChat ? 960 : 680, margin: "0 auto" }}>
        <div style={{ display: "flex", gap: 28, alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }} className="animate-in">
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              ...
              <div style={{ fontFamily: F.mono, fontSize: 18, letterSpacing: "0.25em", color: T.white, marginBottom: 2 }}>
                {hotPlayer?.name}
              </div>
            ...
            <div style={{ background: T.redDim, border: `1px solid ${T.red}40`, padding: "16px 20px", marginBottom: 24 }}>
              <div style={{ fontFamily: F.mono, fontSize: 9, color: T.red, letterSpacing: "0.2em", marginBottom: 8, textTransform: "uppercase" }}>
                {isOnHotSeat ? "Your answer — defend it" : `${hotPlayer?.name}'s answer`}
              </div>
            ...
            {!votingOpen && (
              <div style={{ textAlign: "center", marginBottom: 20 }}>
                <div style={{ fontFamily: F.display, fontSize: 72, lineHeight: 1, color: timer < 20 ? T.red : T.chromeDim }}>
                  {timer}
                </div>
                <p style={{ fontFamily: F.mono, fontSize: 9, color: T.border, letterSpacing: "0.15em", marginTop: 4 }}>SECONDS REMAINING</p>
              </div>
            )}

            {/* Hot seat player controls */}
            {isOnHotSeat && !votingOpen && (
              <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "20px", textAlign: "center", marginBottom: 16 }}>
                <p style={{ fontFamily: F.mono, fontSize: 12, color: T.red, letterSpacing: "0.1em", marginBottom: 8 }}>
                  Defend your answer.
                </p>
                <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, marginBottom: showChat ? 16 : 0 }}>
                  {showChat ? "Type your defence in the chat. When you're done, tap the button below." : "Defend out loud. The group will vote when time is up."}
                </p>
                {showChat && (
                  <button className="btn-primary" onClick={markDefenceDone} style={{ marginTop: 4 }}>
                    I'm done defending →
                  </button>
                )}
              </div>
            ...
            {isOnHotSeat && votingOpen && (
              <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "20px", textAlign: "center" }}>
                <p style={{ fontFamily: F.mono, fontSize: 11, color: T.chromeDim, letterSpacing: "0.1em" }}>
                  Defence time is up. The group is voting…
                </p>
              </div>
            )}

            {/* Other players: vote */}
            {!isOnHotSeat && votingOpen && !myHSVote && (
              <>
                <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, textAlign: "center", marginBottom: 16, letterSpacing: "0.1em" }}>
                  Did {hotPlayer?.name} survive the hot seat?
                </p>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
                  <button className="btn-primary" onClick={() => voteHotSeat(true)} style={{ borderColor: T.green, color: T.green, background: T.greenDim }}>
                    ✓ Survived
                  </button>
                  <button className="btn-chrome" onClick={() => voteHotSeat(false)} style={{ borderColor: T.red, color: T.red }}>
                    ✕ Crumbled
                  </button>
                </div>
              </>
            ...
            {!isOnHotSeat && votingOpen && myHSVote !== undefined && (
              <div style={{ background: T.blueDim, border: `1px solid ${T.blue}40`, padding: "16px", textAlign: "center" }}>
                <p style={{ fontFamily: F.mono, fontSize: 11, color: T.blue, letterSpacing: "0.1em" }}>
                  Voted — waiting for group… ({voteCount}/{totalVoters})
                </p>
              </div>
            )}

            {!isOnHotSeat && !votingOpen && (
              <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "16px", textAlign: "center" }}>
                <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.1em" }}>
                  {showChat ? `Cross-examine ${hotPlayer?.name} in the chat.` : `Listen to ${hotPlayer?.name}'s defence.`}
                  {" "}Vote opens when time's up or they're done.
                </p>
              </div>
            )}
            ...
            {/* Host: skip button */}
            {isHost && (
              <button onClick={skipHotSeat} style={{
                background: "transparent", border: `1px solid ${T.border}`,
                color: T.chromeDim, fontFamily: F.mono, fontSize: 9,
                letterSpacing: "0.15em", textTransform: "uppercase",
                padding: "10px", cursor: "pointer", width: "100%", marginTop: 16,
                transition: "all 0.15s",
              }}
                onMouseEnter={e => { e.target.style.borderColor = T.chromeDim; e.target.style.color = T.chrome; }}
                onMouseLeave={e => { e.target.style.borderColor = T.border; e.target.style.color = T.chromeDim; }}
              >
                Skip Hot Seat →
              </button>
            )}
          ...
          {/* Chat column */}
          {showChat && (
            <div style={{ width: 300, flexShrink: 0, position: "sticky", top: 60 }}>
              <div style={{ fontFamily: F.mono, fontSize: 9, color: T.chromeDim, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 8 }}>
                Chat
              </div>
...
function Results({ room, update, pid, isHost }) {
  ...
  // Sort by fav votes desc
  const ranked = Object.entries(answers)
    .map(([apid, answer]) => ({
      pid: apid,
      answer,
      name: players[apid]?.name || "Unknown",
      score: players[apid]?.score || 0,
      favs: favCounts[apid] || 0,
      leasts: leastCounts[apid] || 0,
      isHotSeat: apid === hotSeat,
    }))
    .sort((a, b) => b.favs - a.favs);

  // Leaderboard (all players)
  const leaderboard = Object.entries(players)
    .map(([apid, p]) => ({ pid: apid, name: p.name, score: p.score || 0 }))
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "72px 24px 60px", maxWidth: 720, margin: "0 auto" }}>
      <div className="animate-in">
        ...
        {/* Hot seat result */}
        <div style={{
          background: hotSeatSurvived ? T.greenDim : T.redDim,
          border: `1px solid ${hotSeatSurvived ? T.green : T.red}40`,
          padding: "16px 20px", marginBottom: 24, textAlign: "center",
        }}>
          <span style={{ fontFamily: F.mono, fontSize: 11, color: hotSeatSurvived ? T.green : T.red, letterSpacing: "0.15em" }}>
            HOT SEAT — {players[hotSeat]?.name} {hotSeatSurvived ? "SURVIVED (+5 pts)" : "CRUMBLED (+2 pts)"}
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
          {ranked.map((r, i) => {
            ...
            return (
              <div key={r.pid} style={{
                background: T.card, border: `1px solid ${i === 0 ? T.gold : T.border}`,
                padding: "18px 20px",
              }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                  <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                    ...
                    <span style={{ fontFamily: F.mono, fontSize: 13, color: T.white, letterSpacing: "0.05em" }}>{r.name}</span>
                    {r.pid === pid && <span style={{ fontFamily: F.mono, fontSize: 9, color: T.chromeDim }}>(you)</span>}
                  </div>
                  <div style={{ display: "flex", gap: 14, fontFamily: F.mono, fontSize: 11, flexShrink: 0 }}>
                    <span style={{ color: T.gold }}>★ {r.favs}</span>
                    <span style={{ color: T.red }}>✕ {r.leasts}</span>
                  </div>
                </div>
                <p style={{ fontSize: 14, lineHeight: 1.7, margin: "0 0 12px" }}>{r.answer}</p>
                <div style={{ height: 2, background: T.border }}>
                  <div style={{ height: "100%", width: favPct + "%", background: T.gold, transition: "width 0.8s 0.2s ease" }} />
                </div>
              </div>
            );
          })}
        ...
        <div className="card" style={{ padding: "24px", marginBottom: 28 }}>
          <p style={{ fontFamily: F.mono, fontSize: 10, color: T.chromeDim, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: 20 }}>
            Leaderboard
          </p>
          {leaderboard.map((p, i) => (
            <div key={p.pid} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 0", borderBottom: i < leaderboard.length - 1 ? `1px solid ${T.border}` : "none" }}>
              <span style={{ fontFamily: F.display, fontSize: 28, color: i === 0 ? T.gold : T.chromeDim, width: 32, lineHeight: 1 }}>
                {i + 1}
              </span>
        ...
        <div style={{ background: T.chromeFaint, border: `1px solid ${T.border}`, padding: "20px 24px", marginBottom: 24, textAlign: "center" }}>
          <p style={{ fontFamily: F.mono, fontSize: 9, color: T.chromeDim, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: 10 }}>
            Discuss
          </p>
          <p style={{ fontSize: 13, color: T.chromeDim, lineHeight: 1.6, margin: 0 }}>
            Does anyone want to change their answer now? Who surprised you? What would you do differently?
          </p>
        </div>

        {isHost ? (
          <button className="btn-primary" onClick={nextRound} style={{ width: "100%" }}>Next Dilemma →</button>
        ) : (
          <p style={{ textAlign: "center", fontFamily: F.mono, fontSize: 11, color: T.chromeDim, letterSpacing: "0.1em" }}>Host will move to next round.</p>
        )}
      </div>
    </div>
  );
...
function Game({ code, pid }) {
  ...
  if (!room) return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <p style={{ fontFamily: F.mono, color: T.chromeDim }}>Loading room…</p>
    </div>
  );
...
export default function App() {
  ...
  const [session, setSession] = useState(null); // { code, pid }

  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.white, fontFamily: F.body }}>
      <style>{css}</style>
      {screen === "landing" && (
        <Landing onHost={() => setScreen("host")} onJoin={() => setScreen("join")} />
      )}
      {screen === "host" && (
        <HostSetup
          onBack={() => setScreen("landing")}
          onCreated={(s) => { setSession(s); setScreen("game"); }}
        />
      )}
      {screen === "join" && (
        <JoinSetup
          onBack={() => setScreen("landing")}
          onJoined={(s) => { setSession(s); setScreen("game"); }}
        />
      )}
      {screen === "game" && session && (
        <Game code={session.code} pid={session.pid} />
      )}
    </div>
  );
}
